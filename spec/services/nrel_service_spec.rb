...
describe NrelService do
  ...
  context "instance methods" do
    context "#station_search" do
      it "returns an array of hashes with station data", vcr: true do
        raw_search = subject.station_search
        raw_stations = raw_search[:fuel_stations]
